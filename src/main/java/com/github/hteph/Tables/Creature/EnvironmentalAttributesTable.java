...
public class EnvironmentalAttributesTable {
    public static void environmentalAttributes(Sophont lifeform, EnvironmentalEnum[] environ) {
        ...
        StellarObject home = CentralRegistry.getFromArchive(lifeform.getHomeworld());
        ...
        switch (environ[0]) {
            ...
            case TEMPERATE_FORESTS:
                lifeform.addToDescription("Evolved in a forest mileau.");
        ...
        if (lifeform.hasAttribute(LocomotionModes.AMPHIBIOUS.getName())) {
        ...
        if (lifeform.hasAttribute(LocomotionModes.CLIMBER.getName()) ){
            ...
            if(Dice._3d6lessThan(8))lifeform.addAttribute("Perfect Balance", "The lifeforms kinestetics allows them to always keep their footing, no matter how narrow the walking surface.");
        }
        ...
        if (lifeform.hasAttribute(BURROWER.getName())) {
            ...
            if(Dice._3d6lessThan(8)) lifeform.addAttribute("Nictating Membrane", "The lifeform have a transparent lens over the eyes that you can open and close like an eyelid. This protects the eyes from irritants.");
            if(Dice._3d6lessThan(8)) lifeform.addAttribute(Attributes.STRENGTH);
        ...
        if(lifeform.hasAttribute(AQUATIC.getName())){
            ...
            if(Dice._3d6lessThan(6)) lifeform.addAttribute("Sonar Vision", "The lifeform uses sound to paint a picture of the surrounding.");
            else if(Dice._3d6lessThan(8))lifeform.addAttribute("Faz Sense", "Can sense weak electric currents.");
        }

        if(lifeform.hasAttribute(GLIDER.getName())){
            if(Dice._3d6lessThan(8)) lifeform.addAttribute(Attributes.AGILITY);
            lifeform.addAttribute("Flight","The lifeform can take to the air.")
                    .addCondition("Gliding","Only gliding flight");
           if(Dice._3d6lessThan(8)) lifeform.addAttribute("Phobia", "Claustrophobia, mild");
            if(Dice._3d6lessThan(10)){
        ...
        if(lifeform.hasAttribute(FLIER.getName())){
            ...
            if(Dice._3d6lessThan(9)) lifeform.addAttribute("Absolute Direction", "The lifeform has developed an excellent sense of direction and navigation.");
            if(Dice._3d6lessThan(8)) lifeform.addAttribute(Attributes.AGILITY);
            if(Dice._3d6lessThan(10)) lifeform.addAttribute("Phobia", "claustrophobia, mild");
            if(Dice._3d6lessThan(10)){
                lifeform.addAttribute("Fragile","The lifeform has hollow bones or otherwise weight reducing bodybuild.");
                lifeform.addAttribute(Attributes.CONSTITUTION,-1);
            }
           if(Dice._3d6lessThan(12) && lifeform.getAttributes().get(FLIER.getName()).hasCondition("Balloon")) lifeform.addAttribute("Phobia", "Sharp objects, mild.");
        }
    }
}